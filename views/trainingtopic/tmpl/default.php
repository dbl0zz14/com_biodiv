...
<?php
	...
	if ( $num_sequences == 0 ) {
		print "<h1>".JText::_("COM_BIODIV_TRAINING_NO_SEQS")."</h1>";
	}
	else {
		...
		print "<h1>".JText::_("COM_BIODIV_TRAINING_WHAT_SEE")."</h1>";
		print "</div>";
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"> <?php print JText::_("COM_BIODIV_TRAINING_MAP_MODAL"); ?> </h4>
      </div>
