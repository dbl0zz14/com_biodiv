...
if ( !$this->personId ) {
	...
	print '<h3>'.$this->translations['nothing_human']['translation_text'].'</h3>';
	
	print '<p>'.$this->translations['nothing_human_help']['translation_text'].'</p>';
	
	print '<div class="user_chart center-block">';
	print '<canvas id="nothingHumanChart" ></canvas>';
	print '</div>'; // user_chart	
