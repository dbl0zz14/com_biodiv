...
$document->addScriptDeclaration("BioDiv.projectId = '".$this->projectId."';");
...
if ( $this->kioskParams ) {
	$document->addScriptDeclaration("BioDiv.kioskParams = '".$this->kioskParams."';");
}


print '	<button id="home_button" class="btn btn-success h2" data-dismiss="modal" title="Home button"> <span class="fa fa-3x fa-home"></span> </button>';

if ( $this->schoolUser and $this->logoPath ) {
...
JHTML::script("com_biodiv/badgekiosk.js", true, true);
