...
function kioskMapSuccess () {
	
	let ac = jQuery("#areaCovered").attr("data-area-covered");
	const areaCovered = JSON.parse ( ac );
	
	let mc = jQuery("#mapCentre").attr("data-map-centre");
	const mapCentre = JSON.parse ( mc );
	
	let iz = jQuery("#initialZoom").attr("data-initial-zoom");
	const initialZoom = JSON.parse ( iz );
	
	let pc = jQuery("#projectCentre").attr("data-project-centre");
	const projectCentre = JSON.parse ( pc );
	
	let pz = jQuery("#projectZoom").attr("data-project-zoom");
	const projectZoom = JSON.parse ( pz );
	
	let ssol = jQuery("#showSitesOnLoad").attr("data-show-sites");
	const showSitesOnLoad = JSON.parse ( ssol ); 
	...
	setUpMap ( areaCovered, mapCentre, initialZoom, showSitesOnLoad );
	...
	// jQuery("#project_area").click(function () {
		// discovermap.setView(projectCentre, projectZoom)
		// showAreas();
	// });
